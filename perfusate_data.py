    ...
    try:
        with pyodbc.connect(connString) as cnxn_istat:
            with cnxn_istat.cursor() as cursor:    
                ...
                HCO3, BE, sO2 = float(HCO3_txt.get()), float(BE_txt.get()), float(sO2_txt.get())
                Hb = float(pH_txt.get())
                ...
                cnxn_istat.commit()    
                Label(istat_tab, text= "Data successfully uploaded!").grid(row= 10, column= 2)
    except ValueError:
        error()
...
Label(istat_tab, text= "TCO2: ").grid(row= 4, column= 1)
TCO2_istat_e = Entry(istat_tab, text= TCO2_istat_txt).grid(row= 4, column= 2)
Label(istat_tab, text= "HCO3: ").grid(row= 5, column= 1)
HCO3_e = Entry(istat_tab, text= HCO3_txt).grid(row= 5, column= 2)
Label(istat_tab, text= "BE: ").grid(row= 6, column= 1)
BE_e = Entry(istat_tab, text= BE_txt).grid(row= 6, column= 2)
Label(istat_tab, text= "sO2: ").grid(row= 7, column= 1)
sO2_e = Entry(istat_tab, text= sO2_txt).grid(row= 7, column= 2)
Label(istat_tab, text= "Hb: ").grid(row= 8, column= 1)
Hb_e = Entry(istat_tab, text= Hb_txt).grid(row= 8, column= 2)

submit_istat = Button(istat_tab, text= "Submit", command= upload_istat).grid(row= 9, column= 2)
