...
with pyodbc.connect('DRIVER={SQL Server};SERVER='+server+';DATABASE='+database+';UID='+username+';PWD='+ password) as cnxn: 
    ...
    while (new_input == "Y"):
        ...
        with cnxn.cursor() as cursor:
            cursor.execute(f"INSERT INTO dbo.istat_t([UNOS_ID], [ph], [pco2], [po2], [tco2], [hco3], [be], [so2], [hb]) VALUES({unos_id}, {pH}, {PCO2}, {PO2}, {TCO2_iStat}, {HCO3}, {BE}, {sO2}, {Hb});")
        ...
        TP = data_input("TB: ")
        with cnxn.cursor() as cursor:
            cursor.execute(f"INSERT INTO dbo.pic_t([UNOS_ID], [Na], [K], [tco2], [Cl], [glu], [Ca], [BUN], [cre], [egfr], [alp], [ast], [tbil], [alb], [tp]) VALUES({unos_id}, {Na}, {K}, {TCO2_Pic}, {Cl}, {Glu}, {Ca}, {BUN}, {Cre}, {eGFR}, {ALP}, {AST}, {TBIL}, {ALB}, {TP});")
